 ...
 * DictionaryPro/src/main/assets/fonts directory.
 * <p>
 ...
 * {@code allowTextSizeChanges} attribute to false in a {@code LangTextView} XML layout.
 */
public class LangTextView extends TextView 
    ...
    public LangTextView(Context context, AttributeSet attrs) {
        ...
        TypedArray attrArray = 
                context.getTheme().obtainStyledAttributes(attrs, R.styleable.lang_text_view, 0, 0);
        try {
    ...
    /**
     * Sets the {@code LangTextView}'s text size to the size stored in the preferences. This method
