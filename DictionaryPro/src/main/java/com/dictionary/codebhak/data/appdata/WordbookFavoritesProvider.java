...
/**
 * A {@link ContentProvider} for the wordbook favorites table.
 */
public class WordbookFavoritesProvider extends ContentProvider {
    
    public static final String AUTHORITY =
            "com.dictionary.codebhak.data.appdata.WordbookFavoritesProvider";
    ...
    private Cursor searchWords(Uri uri, String[] projection, String selection, 
        ...
        queryBuilder.setTables(AppDataContract.WordbookFavorites.TABLE_NAME);
    ...
    public Uri insert(Uri uri, ContentValues values) {
        long rowID = mDatabase.insert(AppDataContract.WordbookFavorites.TABLE_NAME,
                AppDataContract.WordbookFavorites.COLUMN_NAME_WORDBOOK_ID, values);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
        case WORDS:
            affected = mDatabase.delete(AppDataContract.WordbookFavorites.TABLE_NAME,
